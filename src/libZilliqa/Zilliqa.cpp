...
Zilliqa::Zilliqa(const PairOfKey &key, const Peer &peer, SyncType syncType,
    ...
    auto func = [this, toRetrieveHistory, syncType, key, peer]() mutable -> void {
        ...
        switch (syncType) {
            case SyncType::NO_SYNC: LOG_GENERAL(INFO, "No Sync Needed");
                break;
            case SyncType::NEW_SYNC: LOG_GENERAL(INFO, "Sync as a new node");
                ...
                break;
            case SyncType::NEW_LOOKUP_SYNC: LOG_GENERAL(INFO, "Sync as a new lookup node");
                if (toRetrieveHistory) {
                ...
                break;
            case SyncType::NORMAL_SYNC: LOG_GENERAL(INFO, "Sync as a normal node");
                m_n.m_runFromLate = true;
                m_n.StartSynchronization();
                break;
            case SyncType::DS_SYNC: LOG_GENERAL(INFO, "Sync as a ds node");
                m_ds.StartSynchronization(false);
                break;
            case SyncType::LOOKUP_SYNC: LOG_GENERAL(INFO, "Sync as a lookup node");
                m_lookup.CleanVariables();
                m_lookup.StartSynchronization();
                break;
            case SyncType::RECOVERY_ALL_SYNC: LOG_GENERAL(INFO, "Recovery all nodes");
                ...
                break;
            case SyncType::GUARD_DS_SYNC: LOG_GENERAL(INFO, "Sync as a ds guard node");
                ...
                m_ds.RejoinAsDS(false);
                break;
            case SyncType::DB_VERIF: LOG_GENERAL(FATAL, "Use of deprecated syncType=DB_VERIF");
#if 0
...
#endif
                break;
            default: LOG_GENERAL(WARNING, "Invalid Sync Type");
                break;
        }
