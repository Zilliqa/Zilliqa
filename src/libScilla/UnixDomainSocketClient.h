...
#ifndef ZILLIQA_SRC_LIBSCILLA_UNIXDOMAINSOCKETCLIENT_H_
#define ZILLIQA_SRC_LIBSCILLA_UNIXDOMAINSOCKETCLIENT_H_
...
#endif  // ZILLIQA_SRC_LIBSCILLA_UNIXDOMAINSOCKETCLIENT_H_
