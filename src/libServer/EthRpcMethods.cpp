...
using zil::metrics::InstrumentationClass;
...
std::string EthRpcMethods::CreateTransactionEth(
  ...
  if (zil::metrics::Test::Enabled(
          zil::metrics::InstrumentationClass::METRICS_EVM_RPC)) {
    m_ethApiCall->Add(1,
                      {{"api", "calls"}, {"method", "CreateTransactionEth"}});
  }
