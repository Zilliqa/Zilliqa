                                    ...
                                    unsigned int offset)
{
    try
    {
        ...
        if (receipt_size > 0)
        {
            receipt_bytes.resize(receipt_size);
        ...
        m_tranReceiptStr = DataConversion::CharArrayToString(receipt_bytes);
...
string TransactionReceipt::GetString()
{
    if (m_updated)
    {
