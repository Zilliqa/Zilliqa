    ...
    switch (Transaction::GetTransactionType(transaction)) {
        ...
        case Transaction::CONTRACT_CREATION: {
            ...
            m_scillaIPCServer->setContractAddressVerRoot(
                    contractAddress, scilla_version,
            ...
            if (isScilla &&
                !ParseContractCheckerOutput(contractAddress, checkerPrint,
                                            receipt,
                                            t_metadata, gasRemained,
                                            is_library)) {
                ret_checker = false;
            }
            // *************************************************************************
            ...
            if (ret_checker) {
                ...
                if (ret) {
                    ...
                    if (isScilla)
                        ...
                        gasRemained =
                                InvokeEvmInterpreter(contractAccount,
                                                     RUNNER_CREATE, params,
