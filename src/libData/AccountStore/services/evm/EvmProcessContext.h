...
#ifndef ZILLIQA_SRC_LIBDATA_ACCOUNTSTORE_SERVICES_EVM_EVMPROCESSCONTEXT_H_
#define ZILLIQA_SRC_LIBDATA_ACCOUNTSTORE_SERVICES_EVM_EVMPROCESSCONTEXT_H_
...
#endif  // ZILLIQA_SRC_LIBDATA_ACCOUNTSTORE_SERVICES_EVM_EVMPROCESSCONTEXT_H_
