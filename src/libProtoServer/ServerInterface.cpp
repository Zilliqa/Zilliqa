...
class ServerImpl final : public Server::Service {
 ...
 public:
  explicit ServerImpl(Mediator& mediator) : m_mediator(mediator) {
    m_StartTimeTx = 0;
    m_StartTimeDs = 0;
  ...
  Status GetClientVersion(ServerContext* context, const Empty* request,
                          DefaultResponse* response) override {
    return Status::OK;
  }

  Status GetNetworkId(ServerContext* context, const Empty* request,
                      DefaultResponse* response) override {
    return Status::OK;
  }

  Status GetProtocolVersion(ServerContext* context, const Empty* request,
                            DefaultResponse* response) override {
    return Status::OK;
  }

  Status GetGasPrice(ServerContext* context, const Empty* request,
                     DefaultResponse* response) override {
    return Status::OK;
  }

  Status GetStorageAt(ServerContext* context,
                      const GetStorageAtRequest* request,
                      DefaultResponse* response) override {
    return Status::OK;
  }

  Status GetBlockTransactionCount(
      ServerContext* context, const GetBlockTransactionCountRequest* request,
      DefaultResponse* response) override {
    return Status::OK;
  }

  Status CreateMessage(ServerContext* context, const Empty* request,
                       DefaultResponse* response) override {
    return Status::OK;
  }

  Status GetGasEstimate(ServerContext* context, const Empty* request,
                        DefaultResponse* response) override {
    return Status::OK;
  }

  Status GetTransactionReceipt(ServerContext* context,
                               const GetTransactionRequest* request,
                               DefaultResponse* response) override {
    return Status::OK;
  }

  Status isNodeSyncing(ServerContext* context, const Empty* request,
                       DefaultResponse* response) override {
    return Status::OK;
  }

  Status isNodeMining(ServerContext* context, const Empty* request,
                      DefaultResponse* response) override {
    return Status::OK;
  }

  Status GetHashrate(ServerContext* context, const Empty* request,
                     DefaultResponse* response) override {
    return Status::OK;
  }

  Status CreateTransaction(ServerContext* context,
                           const CreateTransactionRequest* request,
                           CreateTransactionResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetTransaction(ServerContext* context,
                        const GetTransactionRequest* request,
                        GetTransactionResponse* ret) override {
    LOG_MARKER();
    ...
    try {
      ...
      LOG_GENERAL(INFO,
                  "[Error]" << e.what() << " Input: " << request->txhash());
      ret->set_error("Unable to Process");
    }
  ...
  Status GetDSBlock(ServerContext* context, const ProtoBlockNum* protoBlockNum,
                    GetDSBlockResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetTxBlock(ServerContext* context, const ProtoBlockNum* protoBlockNum,
                    GetTxBlockResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetLatestDsBlock(ServerContext* context, const Empty* request,
                          GetDSBlockResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetLatestTxBlock(ServerContext* context, const Empty* request,
                          GetTxBlockResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetBalance(ServerContext* context, const ProtoAddress* protoAddress,
                    GetBalanceResponse* ret) override {
    LOG_MARKER();
    ...
    try {
      ...
      LOG_GENERAL(
          INFO, "[Error]" << e.what() << " Input: " << protoAddress->address());
      ret->set_error("Unable To Process");
    }
  ...
  Status GetSmartContractState(ServerContext* context,
                               const ProtoAddress* protoAddress,
                               GetSmartContractStateResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetSmartContractInit(ServerContext* context,
                              const ProtoAddress* protoAddress,
                              GetSmartContractInitResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetSmartContractCode(ServerContext* context,
                              const ProtoAddress* protoAddress,
                              GetSmartContractCodeResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetSmartContracts(ServerContext* context,
                           const ProtoAddress* protoAddress,
                           GetSmartContractResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetContractAddressFromTransactionID(ServerContext* context,
                                             const ProtoTxId* protoTxId,
                                             StringResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetNumPeers(ServerContext* context, const Empty* request,
                     UIntResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetNumTxBlocks(ServerContext* context, const Empty* request,
                        StringResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetNumDSBlocks(ServerContext* context, const Empty* request,
                        StringResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetNumTransactions(ServerContext* context, const Empty* request,
                            StringResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetTransactionRate(ServerContext* context, const Empty* request,
                            DoubleResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetDSBlockRate(ServerContext* context, const Empty* request,
                        DoubleResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetTxBlockRate(ServerContext* context, const Empty* request,
                        DoubleResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetCurrentMiniEpoch(ServerContext* context, const Empty* request,
                             UInt64Response* ret) override {
    LOG_MARKER();
  ...
  Status GetCurrentDSEpoch(ServerContext* context, const Empty* request,
                           UInt64Response* ret) override {
    LOG_MARKER();
  ...
  Status DSBlockListing(ServerContext* context, const ProtoPage* protoPage,
                        ProtoBlockListing* ret) override {
    LOG_MARKER();
  ...
  Status TxBlockListing(ServerContext* context, const ProtoPage* protoPage,
                        ProtoBlockListing* ret) override {
    LOG_MARKER();
  ...
  Status GetBlockchainInfo(ServerContext* context, const Empty* request,
                           ProtoBlockChainInfo* ret) override {
    {
  ...
  Status GetRecentTransactions(ServerContext* context, const Empty* request,
                               ProtoTxHashes* ret) override {
    LOG_MARKER();
  ...
  Status GetShardingStructure(ServerContext* context, const Empty* request,
                              ProtoShardingStruct* ret) override {
    LOG_MARKER();
  ...
  Status GetNumTxnsTxEpoch(ServerContext* context, const Empty* request,
                           UIntResponse* ret) override {
    LOG_MARKER();
  ...
  Status GetNumTxnsDSEpoch(ServerContext* context, const Empty* request,
                           StringResponse* ret) override {
    LOG_MARKER();
