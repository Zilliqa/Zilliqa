...
void Mediator::HeartBeatLaunch()
{
    ...
    auto func = [this]() -> void {
        ...
        // Set timeout to roughly around one DS epoch (doesn't have to be very accurate)
        ...
        while (true)
        {
            ...
            this_thread::sleep_for(
                chrono::seconds(HEARTBEAT_INTERVAL_IN_SECONDS));
            ...
            LOG_GENERAL(WARNING,
                        "No pulse detected - " << m_heartBeatTime
