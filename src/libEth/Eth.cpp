...
/// string
///
/// 32 Bytes - hash of the block where this log was in. null when its pending.
/// null when its pending log blockNumber string
///
/// The block number where this log was in. null when its pending. null when its
/// pending log. transactionIndex string
///
/// Integer of the transactions index position log was created from. null when
/// its pending log. transactionHash string
///
...
/// string
///
/// 20 Bytes - address of the receiver. null when its a contract creation
/// transaction cumulativeGasUsed string
///
...
/// string
///
/// 20 Bytes - The contract address created, if the transaction was a contract
/// creation, otherwise null logs array of objects
///
...
///
/// Integer of the transactions index position log was created from. null when
/// its pending log. address string
///
...
/// valid log. topics array of strings
///
/// Array of zero to four 32 Bytes DATA of indexed log arguments. In solidity:
/// The first topic is the hash of the signature of the event (e.g.
/// Deposit(address,bytes32,uint256)), except you declare the event with the
/// anonymous specifier. transactionHash string
///
/// Hash of the transactions this log was created from. null when its pending
/// log. logsBloom string
///
