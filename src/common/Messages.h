...
enum LookupInstructionType : unsigned char {
  ...
  GETSTATEFROMSEED = 0x06,  // UNUSED
  SETSTATEFROMSEED = 0x07,  // UNUSED
  SETLOOKUPOFFLINE = 0x08,
  SETLOOKUPONLINE = 0x09,
  GETOFFLINELOOKUPS = 0x0A,
  SETOFFLINELOOKUPS = 0x0B,
  RAISESTARTPOW = 0x0C,        // UNUSED
  GETSTARTPOWFROMSEED = 0x0D,  // UNUSED
  SETSTARTPOWFROMSEED = 0x0E,  // UNUSED
  ...
  UNUSED_SETHISTORICALDB = 0x1E,
  GETCOSIGSREWARDSFROMSEED = 0x1F,
  SETMINERINFOFROMSEED = 0x20,
  GETDSBLOCKFROML2LDATAPROVIDER = 0x21,
  GETVCFINALBLOCKFROML2LDATAPROVIDER = 0x22,
  GETMBNFWDTXNFROML2LDATAPROVIDER = 0x23,
  GETPENDINGTXNFROML2LDATAPROVIDER = 0x24,  // UNUSED
  GETMICROBLOCKFROML2LDATAPROVIDER = 0x25,
  GETTXNSFROML2LDATAPROVIDER = 0x26
};
