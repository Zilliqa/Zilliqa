...
bool ARCHIVAL_LOOKUP_WITH_TX_TRACES{
    ReadConstantString("ARCHIVAL_LOOKUP_WITH_TX_TRACES", "node.seed.",
                       "false") == "true"};
bool TX_TRACES{ReadConstantString("TX_TRACES", "node.seed.", "true") == "true"};
...
const uint64_t RPC_QUEUE_SIZE{
    ReadConstantUInt64("RPC_QUEUE_SIZE", "node.jsonrpc.", 100)};
const uint64_t NUM_RPC_THREADS{
    ReadConstantUInt64("NUM_RPC_THREADS", "node.jsonrpc.", 100)};
