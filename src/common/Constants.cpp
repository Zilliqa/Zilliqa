...
const bool LAUNCH_EVM_DAEMON{
 ...
 const std::string METRIC_ZILLIQA_HOSTNAME{ReadConstantString("METRIC_ZILLIQA_HOSTNAME","node.metric.zilliqa.","localhost")};
 const unsigned int METRIC_ZILLIQA_PORT{ReadConstantNumeric("METRIC_ZILLIQA_PORT", "node.metric.zilliqa.")};
 const unsigned int  METRIC_ZILLIQA_READER_EXPORT_MS{ReadConstantNumeric("METRIC_ZILLIQA_READER_EXPORT_MS", "node.metric.zilliqa.")};
 const unsigned int METRIC_ZILLIQA_READER_TIMEOUT_MS{ReadConstantNumeric("METRIC_ZILLIQA_READER_TIMEOUT_MS", "node.metric.zilliqa.")};
 const std::string METRIC_ZILLIQA_SCHEMA{ReadConstantString("METRIC_ZILLIQA_SCHEMA","node.metric.zilliqa.","https://opentelemetry.io/schemas/1.2.0")};
 const std::string METRIC_ZILLIQA_SCHEMA_VERSION{ReadConstantString("METRIC_ZILLIQA_SCHEMA_VERSION","node.metric.zilliqa.","1.2.0")};
