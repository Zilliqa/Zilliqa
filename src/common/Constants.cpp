...
const unsigned int QUERY_MAX_RETRY{
    ReadConstantNumeric("QUERY_MAX_RETRY", "node.node_discovery.")};

const unsigned int QUERY_RETRY_WAIT_TIME_IN_SECONDS{ReadConstantNumeric(
    "QUERY_RETRY_WAIT_TIME_IN_SECONDS", "node.node_discovery.")};
