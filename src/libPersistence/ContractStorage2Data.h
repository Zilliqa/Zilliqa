...
#ifndef ZILLIQA_SRC_LIBPERSISTENCE_CONTRACTSTORAGE2DATA_H_
#define ZILLIQA_SRC_LIBPERSISTENCE_CONTRACTSTORAGE2DATA_H_
...
#endif  // ZILLIQA_SRC_LIBPERSISTENCE_CONTRACTSTORAGE2DATA_H_