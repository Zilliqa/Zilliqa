...
bool DirectoryService::RunConsensusOnFinalBlockWhenDSPrimary() {
  ...
  if (m_consensusMyID == 0 && m_viewChangeCounter < 1) {
    LOG_GENERAL(WARNING, "I am suspending myself to test viewchange (VC_TEST_FB_SUSPEND_1)");
    return false;
  }
  ...
  if (m_consensusMyID == 0 && m_viewChangeCounter < 3) {
    LOG_GENERAL(WARNING, "I am suspending myself to test viewchange (VC_TEST_FB_SUSPEND_3)");
    return false;
  }
#endif  // VC_TEST_FB_SUSPEND_1
  ...
  if (m_consensusMyID == 0 && m_viewChangeCounter < 1) {
    LOG_GENERAL(WARNING, "I am killing myself to test viewchange (VC_TEST_FB_TERMINATE_1)");
    throw exception();
  }
