...
{
    // Zilliqa can support up till 25 shards at max. After which, shard nodes need to compete hard to join shard.
    ...
    static uint32_t result[]
        = {0,   651, 651, 684, 711, 717, 735, 744, 747, 753, 762, 771, 780, 789,
           795, 795, 795, 795, 795, 798, 810, 810, 810, 810, 816, 816, 819};
