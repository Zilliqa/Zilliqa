...
BOOST_AUTO_TEST_CASE(test_eth_get_block_by_number, *boost::unit_test::disabled()) {
  INIT_STDOUT_LOGGER();
...
BOOST_AUTO_TEST_CASE(test_eth_get_block_by_hash, *boost::unit_test::disabled()) {
  INIT_STDOUT_LOGGER();
...
BOOST_AUTO_TEST_CASE(test_eth_get_transaction_by_hash, *boost::unit_test::disabled()) {
  INIT_STDOUT_LOGGER();
...
BOOST_AUTO_TEST_CASE(test_eth_get_transaction_count_by_hash_or_num, *boost::unit_test::disabled()) {
  INIT_STDOUT_LOGGER();
...
BOOST_AUTO_TEST_CASE(test_eth_get_transaction_by_block_and_index, *boost::unit_test::disabled()) {
  INIT_STDOUT_LOGGER();
