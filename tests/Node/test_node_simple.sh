...
for node in {11..20}
do
    python tests/Zilliqa/test_zilliqa_local.py startpow $node 10 0000000000000001 10 03 2b740d75891749f94b6a8ec09f086889066608e4418eda656c93443e8310750a e8cc9106f8a28671d91e2de07b57b828934481fadf6956563b963bb8e5c266bf
done
