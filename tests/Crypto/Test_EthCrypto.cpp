 ...
 *
 * \details Test contract address generation works - should be a keccak of the RLP :
 * https://ethereum.stackexchange.com/questions/760
 */
    BOOST_AUTO_TEST_CASE(TestEthContractAddrGenerate) {
      ...
      auto const sender = DataConversion::HexStrToUint8VecRet("0x6ac7ea33f8831ea9dcc53393aaa88b25a785dbf0");

      std::string addresses[] = {"CD234A471B72BA2F1CCF0A70FCABA648A5EECD8D", "343C43A37D37DFF08AE8C4A11544C718ABB4FCF8", "F778B86FA74E846C4F0A1FBD1335FE81C00A0C91", "FFFD933A0BC612844EAF0C6FE3E5B8E9B6C1D19C"};
