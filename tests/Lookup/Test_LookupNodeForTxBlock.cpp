...
void SendDSBlockFirstToMatchDSBlockNum(Peer& lookup_node)
{
    ...
    DSBlock dsblock(DSBlockHeader(20, prevHash1, 12344, pubKey1.first, pubKey1.second, 0, 789, 0), CoSignatures());
...
BOOST_AUTO_TEST_CASE(testTxBlockStoring)
{
    ...
    TxBlock txblock(TxBlockHeader(TXBLOCKTYPE::FINAL, BLOCKVERSION::VERSION1, 1, 1,
                         ...
                         StateHash(), 0, 5, pubKey1.second, 0, BlockHash(), 0), vector<bool>(1), vector<TxnHash>(5), CoSignatures());
