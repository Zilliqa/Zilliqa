...
def up_cmd(ctx, driver, zilliqa_image, testnet_name, isolated_server_accounts, persistence, key_file, monitoring):
    """
    ...
    up(config, zilliqa_image, testnet_name, isolated_server_accounts, persistence, key_file, monitoring)

def up(config, zilliqa_image, testnet_name, isolated_server_accounts, persistence, key_file, monitoring):
