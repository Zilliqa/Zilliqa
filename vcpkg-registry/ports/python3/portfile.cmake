...
if(VCPKG_TARGET_IS_WINDOWS OR VCPKG_TARGET_IS_UWP)
    ...
    # Adjusted from the Qt port.
    #
    # We set the LD_LIBRARY_PATH so that the (internal) modules in dyn-load are compiled
    # and imported properly; otherwise if some of their required shared libraries aren't
    # found they'll be renamed to have a '_failed' suffix and won't be available when
    # importing them.
    #
    # Notice that the x64-linux-dynamic community triplet will fix the ELF rpath header
    # to the relative shared libraries.
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
        set(_path_suffix_ "/debug")
    endif()
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
        set(_path_suffix_ "")
    endif()

    set(_installed_libpath_ "${CURRENT_INSTALLED_DIR}${_path_suffix_}/lib")
